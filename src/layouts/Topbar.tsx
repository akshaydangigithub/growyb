...
// actions
import { showRightSidebar, changeSidebarType } from "../redux/actions.ts";

// store
import { RootState, AppDispatch } from "../redux/store.ts";

//constants
import { LayoutTypes, SideBarTypes } from "../constants/layout.ts";

// components
import TopbarSearch from "../components/TopbarSearch.tsx";
import MaximizeScreen from "../components/MaximizeScreen.tsx";
...
import logoDark from "../assetss/growYB-logo (2).png";
import logoSm from "../assetss/growYB-logo (2).png";
      ...
      <div className={`navbar-custom ${navbarCssClasses}`}>
        <div className={containerCssClasses}>
          ...
          <ul className="list-unstyled topnav-menu float-end mb-0">
            ...
            <li className="dropdown notification-list topbar-dropdown">
              <ProfileDropdown
                profilePic={`http://localhost:8080/api/company/img/${profile}`}
